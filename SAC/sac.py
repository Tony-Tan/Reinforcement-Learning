...
parser.add_argument('--critic_hidden_layer', default=[256, 256], help='critic hidden perceptron size')
parser.add_argument('--actor_hidden_layer', default=[256, 256], help='acot hidden perceptron size')
parser.add_argument('--critic_lr', default=1e-3, help='critic learning rate')
parser.add_argument('--actor_lr', default=1e-3, help='actor learning rate')
parser.add_argument('--batch_size', default=256, help='actor critic update batch_size')
...
parser.add_argument('--heat', default=0.2, help='entropy coefficient, $\\alpha$ in paper')
parser.add_argument('--trajectory_size_each_round', default=50, help='how many steps to play between each update')
...
parser.add_argument('--agent_path', default='./data/models/checkpoint.pt',
