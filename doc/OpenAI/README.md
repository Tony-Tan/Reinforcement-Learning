...
- Deep Q-Learning
    ...
    - [x] [Dueling Network Architectures for Deep Reinforcement Learning](https://arxiv.org/abs/1511.06581), Wang et al, 2015. *Algorithm: Dueling DQN.*
...
- Policy Gradients
    ...
    - [x] [High-Dimensional Continuous Control Using Generalized Advantage Estimation](https://arxiv.org/abs/1506.02438), Schulman et al, 2015. *Algorithm: GAE.*
